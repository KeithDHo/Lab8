describe('Basic user flow for SPA ', () => {
  ...
  it('Test5: On first Entry page - checking <entry-page> contents', async () => {
    ...
    expect(plainValue).toEqual(entry1);
  ...
  it('Test6: On first Entry page - checking <body> element classes', async () => {
    ...
    // await page.click('journal-entry');
    const attribute = await page.$eval('body', (element) => {
  ...
  it('Test13: On the home page the <body> element should not have any class attribute', async () => {
    const attribute = await page.$eval('body', (head) => {
  ...
  it('Test16: On second Entry page - checking <entry-page> contents', async () => {
    ...
    expect(plainValue).toEqual(entry2);

  }, 10000);

  // implement test17: Clicking on the third journal entry should update the URL to contain “/#entry3”
  ...
  it('Test18: On third Entry page - checking page header title', async () => {
    // implement test18: Clicking on the third journal entry should update the header text to “Entry 3” 
    // await page.click('journal-entry');
    const header = await page.$eval('header > h1', (head) => {
      return head.innerHTML;
    })
  ...
  it('Test19: On third Entry page - checking <entry-page> contents', async () => {
    ...
    expect(plainValue).toEqual(entry3);

  }, 10000);

  it('Test20: On third Entry page - checking <body> element classes', async () => {
    // implement test20: Clicking on the third journal entry should update the class attribute of <body> to ‘single-entry’
